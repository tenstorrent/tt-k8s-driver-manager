...
project_name = os.environ.get("DOCS_PROJECT", "Driver Manager")
project_code = os.environ.get("DOCS_PROJECT_CODE", "tt-k8s-driver-manager")
...
chart_readme = os.environ.get("DOCS_CHART_README", "charts/tt-k8s-driver-manager/README.md")
# ============================================================================
